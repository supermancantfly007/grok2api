...
const AccountHealthPage = lazyNamed(() => import("@/features/accounts/account-health-page"), "AccountHealthPage");
...
export function DeferredAccountHealthPage() {
  return <DeferredPage page={AccountHealthPage} />;
}
